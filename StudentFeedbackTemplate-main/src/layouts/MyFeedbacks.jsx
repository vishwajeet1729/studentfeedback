...
const MyFeedbacks=({teacherId,flag})=>{
  ...
  const fetchUrl=len>0?`http://studentfeedback-five.vercel.app/feedback/myFeedbacks/${teacherId}`:`http://studentfeedback-five.vercel.app/feedback/myFeedbacks/${user.teacher._id}`
   ...
   // console.log('fetcg ',fetchUrl)
      ...
      useEffect(()=>{
       ...
       // const fet=`http://studentfeedback-five.vercel.app/feedback/myFeedbacks/${user.teacher._id}`
       // console.log(fet)
        const fet=fetchUrl
